...
public class ExpectedExceptionTests {
    ...
    @Test(groups = "expectedExceptionsTest", expectedExceptions = EmptyStackException.class)
    ...
    @Test(groups = "expectedExceptionsTest", expectedExceptions = NullPointerException.class)
    public void testExpectedExceptionsMyStackContains() {
        MyStack<String> stack = new MyStack<>();
        stack.contains(null);
    }

    @Test(groups = "expectedExceptionsTest", expectedExceptions = NoSuchElementException.class)
    ...
    @Test(groups = "expectedExceptionsTest", expectedExceptions = EmptyQueueException.class)
    ...
    @Test(groups = "expectedExceptionsTest", expectedExceptions = IndexOutOfBoundsException.class)
